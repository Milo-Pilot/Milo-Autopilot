/**
 @file read9axis.FaBo9Axis_BMX055.h
...
#ifndef FABO9AXIS_BMX055_H
#define FABO9AXIS_BMX055_H
...
{
public:
	FaBo9Axis(int accl = BMX055_ACC_SLAVE_ADDRESS_DEFAULT, int gyro = BMX055_GYRO_SLAVE_ADDRESS_DEFAULT, int mag = BMX055_MAG_SLAVE_ADDRESS_DEFAULT);
	bool begin(void);
...
private:
	void writeI2c(byte devise_addr, byte register_addr, byte value);
	void readI2c(byte devise_addr, byte register_addr, int num, byte *buf);
};
